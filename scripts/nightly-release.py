...
SITE_ROOT = "sites/initiative"
RELEASES_ROOT = f"{SITE_ROOT}/src/pages/releases"
        ...
        "messages": [
            {
                "role": "user",
                "content": (
                    "You are writing release notes for the AEGIS Initiative "
                    "site (public org home — roadmap, brand presence, "
                    "ecosystem overview). Convert these development "
